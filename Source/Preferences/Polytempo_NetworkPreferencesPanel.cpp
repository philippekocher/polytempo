...
public:
    ...
    void resized() override
    {
        ...
        displayMilliseconds->setBounds(30, 310, proportionOfWidth(0.9f), 24);
    }
...
public:
    AudioPreferencesPage() : audioDeviceManager(Polytempo_AudioDeviceManager::getSharedAudioDeviceManager())
    {
        /* audio main toggle
         -------------------------------------------------- */
    ...
    void paintCell(Graphics& g, int rowNumber, int columnId, int width, int height, bool /*rowIsSelected*/) override
    {
        ...
        if (rowNumber < ipAddresses.size() && rowNumber >= 0)
        {
            ...
            case ColumnIdRange:
                ...
                break;
            case ColumnIdType:
                text = ipAddresses[rowNumber].addressDescription();
                break;
            default:
                text = "";
            }
