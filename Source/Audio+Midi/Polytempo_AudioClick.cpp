...
{
public:
    SineWaveVoice() : currentAngle(0), angleDelta(0.0), level(0), tailOff(0.0)
    {
    }
...
public:
    ...
    SynthAudioSource(MidiKeyboardState& aKeyboardState, Synthesiser& aSynth) : keyboardState(aKeyboardState), synth(aSynth)
    {
...
Polytempo_AudioClick::Polytempo_AudioClick(): audioDeviceManager(Polytempo_AudioDeviceManager::getSharedAudioDeviceManager())
{
